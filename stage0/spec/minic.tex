...
lógicos (apenas \verb|&&|). Os operadores unários são o de negação 
lógica (\verb|!|) e
...
funções. Também não é possível alterar o valor das variáveis, pois 
comandos de atribuição não existem no estágio 0. 
