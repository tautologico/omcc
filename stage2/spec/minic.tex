...
no estágio 1 o número de características que faltam ainda é bastante 
...
não são suportados no estágio 1. 
...
muita coisa com a linguagem no estágio 1. Só há um tipo básico: 
inteiros (\texttt{int}). Não é possível declarar variáveis; as únicas
variáveis presentes em programas no estágio 1 são os parâmetros das 
...
\end{array}
\]
\caption{Gramática da linguagem MiniC -- Estágio 1} \label{fig:gramminic}
\end{figure}
