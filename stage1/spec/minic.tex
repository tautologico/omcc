...
\title{Construção de Compiladores II \\
       Guia da Linguagem MiniC -- Estágio 1}
...
compilador com a inclusão dessas novas características. O estágio 1, 
descrito neste guia, tem todas as características do estágio 0 (expressões, 
declaração e chamada de funções) e adiciona suporte à mudança de valores
nas variáveis, através do comando de atribuição. 
...
funções. É possível alterar o valor de variáveis com atribuições, 
mas isso só serve para alterar o valor de um parâmetro. 
